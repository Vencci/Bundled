...
class RecipeStepCell6: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "coatM")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "COAT in 2-cup microwave-safe cereal bowl with cooking spray. ADD egg and milk; BEAT until blended. ADD sausage."
