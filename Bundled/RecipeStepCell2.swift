...
class RecipeStepCell2: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "cookF")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "COOK until golden brown and no visible liquid egg remains, 2 to 3 minutes per side. REPEAT to cook remaining bread. SERVE immediately."
