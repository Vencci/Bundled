...
class VideoCell2: BaseCell{
    ...
    let bundleImageView: UIImageView = {
        ...
        imageView1.image = UIImage(named: "flatpizzaImage")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "BEAT eggs, milk and nutmeg in shallow dish until blended."
    ...
    override func setupViews(){
        ...
        let path: String? = Bundle.main.path(forResource: "beategg", ofType: "mp4")
