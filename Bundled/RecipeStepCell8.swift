...
class RecipeStepCell8: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "boilpotatoImage")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "Place the potatoes in a large pot, and fill with about 1 inch of water. Bring to a boil, and cook for about 15 minutes, or until potatoes are tender. "
