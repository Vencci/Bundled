...
class VideoCell4: BaseCell{
    ...
    let titleLabel1: UILabel = {
        ...
        lable.text = "peel carrots nicely, and cut them into prices"
        return lable
    }()
    ...
    let bundleImageView: UIImageView = {
        ...
        imageView1.image = UIImage(named: "glazecarrot")
    ...
    override func setupViews(){
        ...
        let path: String? = Bundle.main.path(forResource: "carrot", ofType: "mp4")
