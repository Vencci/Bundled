...
class VideoCell6: BaseCell{
    ...
    let titleLabel1: UILabel = {
        ...
        lable.text = "take the skin off a salmon"
        return lable
    }()
    ...
    let bundleImageView: UIImageView = {
        ...
        imageView1.image = UIImage(named: "mangofillet")
    ...
    override func setupViews(){
        ...
        let path: String? = Bundle.main.path(forResource: "peelsalmon", ofType: "mp4")
