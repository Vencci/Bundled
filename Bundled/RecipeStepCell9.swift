...
class RecipeStepCell9: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "saladDressing")
    ...
    let bundleImageView: UIImageView = {
        ...
        imageView1.image = UIImage(named: "greenBeanandPotatoImage")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "In a medium bowl, whisk together the balsamic vinegar, mustard, lemon juice, garlic, Worcestershire sauce and olive oil. Pour over the salad, and stir to coat."
