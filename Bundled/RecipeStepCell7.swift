...
class RecipeStepCell7: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "cookM")
    ...
    let bundleImageView: UIImageView = {
        ...
        imageView1.image = UIImage(named: "asianbeefImage")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "MICROWAVE on HIGH 30 seconds; push cooked edges toward center. MICROWAVE until egg is almost set, about 15 to 45 seconds longer."
