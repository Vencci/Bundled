...
class RecipeStepCell4: BaseCell{
    ...
    let thumbnailImageView: UIView = {
        ...
        imageView.image = UIImage(named: "pourS")
    ...
    let titleLabel: UILabel = {
        ...
        lable.text = "POUR IN egg mixture. As eggs begin to set, GENTLY PULL the eggs across the pan with a spatula, forming large soft curds."
